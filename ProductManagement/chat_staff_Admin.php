...
$select = mysqli_query($conn, "select * from tim_operasional");
...
<body>
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="chat_staff_Admin.php" class="active">Chat Staff</a>
    ...
    <div class="chat-container">
            <div class="contacts">
                <div class="contact-group">
                    ...
                    ?>
                        <a href="chat_staff_Admin.php?id_operasional=<?php echo $staff['id_operasional'] ?>">
                            <button class="contact" type="button"><?php echo $staff['nama'] ?></button>
                        </a>
                    <?php
                    }
                    ?>
            ...
            <div class="chat">
                <?php
                if (isset($_GET['id_operasional'])) {
                    $id_operasional = $_GET['id_operasional'];
                    $name = mysqli_query($conn, "SELECT * FROM tim_operasional WHERE id_operasional = $id_operasional");
                ...
                ?>
                    <div class="messages">
                        ...
                        $message = mysqli_query($conn, "SELECT * FROM message WHERE id_receiver = $id_operasional AND receiver_type = 'staff'");
                    ...
                    <form method="POST" action="chat_control.php?id_receiver=<?php echo $id_operasional ?>&user=staff">
